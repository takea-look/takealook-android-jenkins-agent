...
RUN mkdir -p /opt/java && \
    curl -L -o /tmp/temurin.tar.gz https://github.com/adoptium/temurin17-binaries/releases/download/jdk-17.0.15+6/OpenJDK17U-jdk_x64_linux_hotspot_17.0.15_6.tar.gz && \
